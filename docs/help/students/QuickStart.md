...
![Diagram with 4 key features: smarter team allocations, tools to help you
record meetings & attendance, regular peer reviews to identify issues, and more
data to help make marking fairer.](../../images/students-key-features.png)
...
![Diagram showing the key phases of group coursework that uses the app.](../../images/students-process-overview.png)
